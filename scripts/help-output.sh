...
PLUGIN_ROOT="${1:-${SWT_INSTALL_ROOT:-}}"
...
echo "  swt help <command>                      Details on a specific command"
echo "  swt config                              View and change settings"
echo ""
echo "  Getting Started: swt init → swt cook → swt cook --archive"
