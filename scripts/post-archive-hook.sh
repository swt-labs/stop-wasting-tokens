...
ROOT_HELPER="$SCRIPT_DIR/lib/swt-config-root.sh"
...
DEFAULT_CONFIG_PATH="${VBW_PLANNING_DIR:-$BASE_ROOT/.swt-planning}/config.json"
...
export SWT_CONFIG_ROOT="$PROJECT_ROOT"
