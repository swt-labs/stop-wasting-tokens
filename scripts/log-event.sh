...
# Appends a structured event to .swt-planning/.events/event-log.jsonl
...
# shellcheck disable=SC2034 # CONFIG_PATH declared for consistency with other SWT scripts
