...
# Resolve SWT workspace root (fail-open) so SWT_CONFIG_ROOT is available for
...
# Make absolute — resolve relative paths against SWT workspace root, falling back to cwd
