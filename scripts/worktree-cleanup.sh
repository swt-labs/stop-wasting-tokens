#!/bin/bash
set -u
# worktree-cleanup.sh — Remove a SWT agent worktree and its branch.
...
WORKTREES_PARENT=".swt-worktrees"
...
# Remove residual filesystem artifacts (e.g. .swt-planning/, .DS_Store)
...
# Remove parent .swt-worktrees/ if now empty
