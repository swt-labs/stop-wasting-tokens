...
reject_milestone_phase_dir() {
  ...
  case "$phase_dir" in
    */.swt-planning/milestones/*|.swt-planning/milestones/*)
      ...
      echo "Remediation must target active phases in .swt-planning/phases/" >&2
...
canonicalize_phase_dir() {
  ...
  case "$candidate" in
    */.swt-planning/phases/*) ;;
    *)
      echo "Error: UAT remediation phase must be under active .swt-planning/phases/: $candidate" >&2
