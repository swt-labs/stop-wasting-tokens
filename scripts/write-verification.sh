...
# Excludes .swt-planning/ and CLAUDE.md so planning commits don't invalidate QA
verified_at_commit=$(git log -1 --format='%H' -- . ':!.swt-planning' ':!CLAUDE.md' 2>/dev/null || echo "")
