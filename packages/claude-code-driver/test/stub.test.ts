...
import { ClaudeCodeAgentSpawner, PACKAGE_NAME, STATUS, VERSION } from '../src/index.js';
...
describe('@swt-labs/claude-code-driver package metadata', () => {
  it('exports canonical package name', () => {
    expect(PACKAGE_NAME).toBe('@swt-labs/claude-code-driver');
  });
