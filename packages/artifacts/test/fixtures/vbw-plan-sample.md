...
must_haves:
  [
    {
      'truths': ['The orchestrator runs Lead before Dev'],
      'artifacts': ['packages/methodology/src/vibe/handlers/plan.ts'],
      'key_links': ['docs/orchestration.md'],
    },
    'Light requirement that ships as a string',
  ]
