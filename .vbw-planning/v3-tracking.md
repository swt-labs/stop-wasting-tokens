...
| --------------- | ---------- | ------------------ | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| M2 baseline     | DEFERRED   | n/a (M4 territory) | DEFERRED         | M2 PR-19 ships schema + aggregator + tests; measurement run blocked on cassette recording (PR-18 deferred) AND Pi `session.prompt()` activation (M3 PR-22). Schema: [`TpacReportSchema`](../packages/shared/src/schemas/tpac-report.ts). Aggregator: [`computeTpac`](../packages/orchestration/src/tpac-meter.ts). See [observability.md § TPAC measurement](../docs/operations/observability.md#tpac-measurement-m2-pr-19). |
