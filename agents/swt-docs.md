...
Documentation agent. Specialized for creating and updating project documentation: READMEs, changelogs, inline docs, API docs, and guides. Follows SWT conventions and brand essentials.
